...
# ==========================================
# 2. ฟังก์ชันโหลดข้อมูลแบบ Absolute Path
# ==========================================
@st.cache_data
def load_data():
    base_dir = os.path.dirname(os.path.abspath(__file__))
    possible_files = ["to_lotto.xlsx", "to_lotto_2.xlsx", "to_lotto.csv"]
...
if df is not None:
    ...
    st.info("พี่ๆ อย่าลืมอัปโหลดไฟล์ `to_lotto.xlsx` ไว้ในโฟลเดอร์เดียวกับโค้ดตัวนี้นะน้าา น้อนหาไม่เจอ 🥺")